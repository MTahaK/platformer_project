...
std::vector<int> Input::s_trackedKeys_ = {
	...
	GLFW_KEY_R,			 GLFW_KEY_F,	 GLFW_KEY_G,	  GLFW_KEY_H,	 GLFW_KEY_J,	 GLFW_KEY_K,  GLFW_KEY_L,
	GLFW_KEY_Z,			 GLFW_KEY_X,	 GLFW_KEY_Y,	  GLFW_KEY_T,	 GLFW_KEY_P,	 GLFW_KEY_O,  GLFW_KEY_1,
	GLFW_KEY_2,			 GLFW_KEY_3,	 GLFW_KEY_4,	  GLFW_KEY_F1,	 GLFW_KEY_F2,	 GLFW_KEY_F3, GLFW_KEY_F4,
};